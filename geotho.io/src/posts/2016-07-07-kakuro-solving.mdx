...
I've written a Kakuro solver which you can try here: <a href="http://geotho.github.io/kakuro-solver/">http://geotho.github.io/kakuro-solver/</a>.

If you are interested in seeing the solving code, you can do so <a href="https://github.com/geotho/kakuro-solver/blob/master/src/js/kakuro.coffee">here</a>.

Below I describe some methods I tried to solve the Kakuros, some more successful than others.
...
![Uniquely determinable cell](/images/small_kakuro.png)
