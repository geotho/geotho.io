...
![VSCode doesn’t know to suggest “HelloWorld”](/images/vscode-bug-2.png "VSCode doesn't know to suggest 'HelloWorld'")

*VSCode fails to suggest "HelloWorld".*

![Specifying the struct works around the bug](/images/vscode-bug-3.png "Specifying the struct works around the bug")

*Specifying the struct works around the bug.*
