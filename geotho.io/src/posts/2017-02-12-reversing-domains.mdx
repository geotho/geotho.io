...
A common complaint about whiteboard coding questions is that they do not resemble a software engineer’s day-to-day work. So I like to note the times when these fun toy algorithms have actually come in handy.
...
That way, you can make use of BigTable’s prefix scanning to find all entries related to “*.example.co.uk”. (Our actual use case was to reverse emails so that “[hello.world@example.co.uk](mailto:hello.world@example.co.uk)” became “[uk.co.example@hello.world](mailto:uk.co.example@hello.world)”, for the same reason).
