...
I’ve written [`cmdotp`](https://github.com/geotho/cmdotp), which you can use to store and generate 2FA codes on your computer. They are stored encrypted in your home folder. It requires a password any time you want to access the codes.

You could use something like [Authy](https://www.authy.com/) but there’s something about cloud-syncing my 2FA codes that doesn’t sit right with me.
